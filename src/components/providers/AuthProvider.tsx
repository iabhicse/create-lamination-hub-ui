...
import { LoginFormInputs } from "../context/auth/LoginPage";
import { RegistrationFormInputs } from "../context/auth/RegistrationPage";
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const signupUser = async (data: RegistrationFormInputs) => {
    setIsLoading(true);
    try {
  ...
  const signinUser = async (data: LoginFormInputs) => {
    setIsLoading(true);
    try {
