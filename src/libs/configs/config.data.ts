...
export const navigationLinks: Array<extendedNavlink> = [
  ...
  { id: "collections", label: "Collections", href: "/collections", icon: "Collection" }, // Lucide: Collection
...
export const footerLinks: footerLinks = {
  footer_messages: {
    ...
    description: "Creating personalized gifts that celebrate life's special moments. Quality craftsmanship meets personal touch.",
  ...
  quickLinks: [
    ...
    { id: "Corporate Gifts", label: "Corporate Gifts", href: "/", icon: "Building" }, // Lucide: Building
  ],

  customerService: [
    { id: "Contact Us", label: "Contact Us", href: "/", icon: "Mail" }, // Lucide: Mail or Phone
    { id: "Shipping Info", label: "Shipping Info", href: "/", icon: "ShippingFast" }, // Lucide: ShippingFast
  ...
  features: [
    { id: "Free Shipping", label: "Free Shipping", href: "/", icon: "ShippingFast" }, // Lucide: ShippingFast
    { id: "30-Day Returns", label: "30-Day Returns", href: "/", icon: "ArrowLeftRight" }, // Lucide: ArrowLeftRight
